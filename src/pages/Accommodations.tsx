...
import { Search, MapPin, Star, Users, Wifi, Car, Coffee, Heart, Eye, Bed } from "lucide-react"
...
export default function Accommodations() {
  ...
  const accommodations = [
    // 🏨 HOTELS
    {
      ...
      inquireEmail: "info@splashmountainhotel.com",
    ...
    },
    {
      ...
      inquireEmail: "reservations@81hotelcalamba.com",
      wikiUrl: "https://en.wikipedia.org/wiki/Calamba,_Laguna",
    },
    {
      id: 3,
      ...
      coordinates: { lat: 14.15, lng: 121.25 },
      inquireEmail: "info@solyviento.com",
      wikiUrl: "https://en.wikipedia.org/wiki/Los_Ba%C3%B1os,_Laguna",
    },
    {
      id: 4,
      ...
      location: "Los Baños, Laguna",
      coordinates: { lat: 14.1693, lng: 121.2407 },
      inquireEmail: "reservations@makilingheights.com",
    ...
    },
    {
      ...
      location: "Los Baños, Laguna",
      coordinates: { lat: 14.1693, lng: 121.2407 },
      inquireEmail: "events@tracesuites.com",
      wikiUrl: "https://en.wikipedia.org/wiki/Los_Ba%C3%B1os,_Laguna",
    },
    ...
    // 🏝 RESORTS
    {
      ...
      inquireEmail: "reservations@villaescudero.com",
    ...
    },
    {
      ...
      coordinates: { lat: 14.3094, lng: 121.4737 },
      inquireEmail: "info@calirayaresort.com",
      wikiUrl: "https://en.wikipedia.org/wiki/Caliraya_Lake",
    },
    {
      id: 8,
      ...
      location: "Pansol, Laguna",
      coordinates: { lat: 14.15, lng: 121.25 },
      inquireEmail: "bookings@rockpointresort.com",
      wikiUrl: "https://en.wikipedia.org/wiki/Los_Ba%C3%B1os,_Laguna",
    },
    {
      id: 9,
      ...
      inquireEmail: "info@batosprings.com",
    ...
    // 🛏 HOSTELS
    {
      ...
      location: "Los Baños, Laguna",
      coordinates: { lat: 14.1693, lng: 121.2407 },
      inquireEmail: "stay@losbañoshostel.com",
      wikiUrl: "https://en.wikipedia.org/wiki/Los_Ba%C3%B1os,_Laguna",
    },
    {
      id: 12,
      ...
      location: "Calamba, Laguna",
      coordinates: { lat: 14.2167, lng: 121.1667 },
      inquireEmail: "info@calambahostel.com",
      wikiUrl: "https://en.wikipedia.org/wiki/Calamba,_Laguna",
    },
    {
      id: 13,
      ...
      location: "San Pablo, Laguna",
      coordinates: { lat: 14.0683, lng: 121.3256 },
      inquireEmail: "backpackers@sevenlakes.com",
    ...
    },
    {
      ...
      location: "Pansol, Laguna",
      coordinates: { lat: 14.15, lng: 121.25 },
      inquireEmail: "stay@pansolinn.com",
      wikiUrl: "https://en.wikipedia.org/wiki/Los_Ba%C3%B1os,_Laguna",
    },
    {
      id: 15,
      ...
      location: "Los Baños, Laguna",
      coordinates: { lat: 14.1693, lng: 121.2407 },
      inquireEmail: "students@lagunastudent.com",
      wikiUrl: "https://en.wikipedia.org/wiki/Los_Ba%C3%B1os,_Laguna",
    },
    ...
    // 🏢 APARTMENTS
    {
      ...
      coordinates: { lat: 14.3167, lng: 121.1167 },
      inquireEmail: "leasing@nuvaliapartments.com",
      wikiUrl: "https://en.wikipedia.org/wiki/Santa_Rosa,_Laguna",
    },
    {
      id: 17,
      ...
      location: "San Pablo, Laguna",
      coordinates: { lat: 14.0683, lng: 121.3256 },
      inquireEmail: "rentals@sanpabloapt.com",
      wikiUrl: "https://en.wikipedia.org/wiki/San_Pablo,_Laguna",
    },
    {
      id: 18,
      ...
      location: "Calamba, Laguna",
      coordinates: { lat: 14.2167, lng: 121.1667 },
      inquireEmail: "executive@calambaexec.com",
      wikiUrl: "https://en.wikipedia.org/wiki/Calamba,_Laguna",
    },
    {
      id: 19,
      ...
      location: "Sta. Rosa, Laguna",
      coordinates: { lat: 14.3167, lng: 121.1167 },
      inquireEmail: "service@starosaserviced.com",
      wikiUrl: "https://en.wikipedia.org/wiki/Santa_Rosa,_Laguna",
    },
    {
      id: 20,
      ...
      location: "Bay, Laguna",
      coordinates: { lat: 14.1833, lng: 121.2833 },
      inquireEmail: "longstay@bayapartments.com",
      wikiUrl: "https://en.wikipedia.org/wiki/Bay,_Laguna",
    },
    ...
    // 🏡 GUESTHOUSES
    {
      ...
      location: "San Pablo, Laguna",
      coordinates: { lat: 14.0683, lng: 121.3256 },
      inquireEmail: "casa@casasanpablo.com",
      wikiUrl: "https://en.wikipedia.org/wiki/San_Pablo,_Laguna",
    },
    {
      id: 22,
      ...
      location: "San Pablo, Laguna",
      coordinates: { lat: 14.0683, lng: 121.3256 },
      inquireEmail: "farm@sitiodeamor.com",
      wikiUrl: "https://en.wikipedia.org/wiki/San_Pablo,_Laguna",
    },
    {
      id: 23,
      ...
      location: "San Pablo, Laguna",
      coordinates: { lat: 14.0683, lng: 121.3256 },
      inquireEmail: "retreat@acuatico.com",
      wikiUrl: "https://en.wikipedia.org/wiki/San_Pablo,_Laguna",
    },
    {
      id: 24,
      ...
      location: "San Pablo, Laguna",
      coordinates: { lat: 14.0683, lng: 121.3256 },
      inquireEmail: "heritage@sulyap.com",
      wikiUrl: "https://en.wikipedia.org/wiki/San_Pablo,_Laguna",
    },
    {
      id: 25,
      ...
      inquireEmail: "farm@woodsidefarm.com",
      wikiUrl: "https://en.wikipedia.org/wiki/Nagcarlan,_Laguna",
    },
  ]
    ...
    <div className="p-6 space-y-8">
      ...
      <div className="text-center">
        <p className="text-muted-foreground">
          ...
          {filteredAccommodations.length === 1 ? "accommodation" : "accommodations"}
        </p>
      </div>
          ...
          >
            ...
            <CardHeader className="space-y-2">
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className={`text-sm font-medium ${getRatingColor(acc.rating)}`}>{acc.rating}</span>
                </div>
              </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button variant="default" className="flex-1" size="sm" onClick={() => handleViewDetails(acc)}>
              ...
              <div className="text-xs text-muted-foreground text-center">{acc.reviews} reviews</div>
            </CardContent>
          </Card>
        ))}
      </div>
      ...
      {selectedAccommodation && (
        <ActionModal
          ...
          title="Accommodation Actions"
          location={{
            lat: selectedAccommodation.coordinates.lat,
            lng: selectedAccommodation.coordinates.lng,
            name: selectedAccommodation.name,
            address: selectedAccommodation.location,
          }}
          type="accommodation"
          inquireEmail={selectedAccommodation.inquireEmail}
          wikiUrl={selectedAccommodation.wikiUrl}
        />
      )}
    </div>
  )
